...
Adicione também uma seção final com:
- Total diário calculado
- Substituições possíveis por refeição
- Dicas de preparação

Mantenha foco em alimentos típicos hispânicos como arepa, quinoa, frijoles, aguacate, plátano, etc.

Exemplo de formato:
🍳 **Café da manhã**
- Arepa integral (60g) → 130 kcal | 4g P | 27g C | 1g G
- Queso fresco magro (40g) → 80 kcal | 8g P | 1g C | 4g G

Mantenha exatamente os macros especificados no total diário.)
